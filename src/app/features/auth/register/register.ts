...
@Component({
  ...
  imports: [BackToHomeButtonComponent, BackgroundComponent, ReactiveFormsModule, FormsModule, CommonModule, RouterModule],
...
export class Register {
  ...
  private getFieldLabel(fieldName: string): string {
    const labels: { [key: string]: string } = {
      ...
      legajo: 'El legajo',
      pregunta_secreta: 'La pregunta secreta',
      respuesta_secreta: 'La respuesta secreta'
    };
  ...
  private getPatternError(fieldName: string): string {
    const errors: { [key: string]: string } = {
      ...
      respuesta_secreta: 'La respuesta debe tener al menos 2 caracteres'
    };
