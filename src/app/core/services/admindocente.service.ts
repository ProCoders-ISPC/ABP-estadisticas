...
import { AdminDocenteLocalService } from './admindocente-local.service';
...
export class AdminDocenteService {
  ...
  constructor(
    ...
    private adminDocenteLocalService: AdminDocenteLocalService
  ) {}
  ...
  getDocentesCarga(
    ...
    if (this.useLocalStorage) {
      return this.adminDocenteLocalService.getDocentesCarga(termino, estado, area, page, limit);
    }
  ...
  getDocenteCarga(id: number): Observable<DocenteCarga> {
    if (this.useLocalStorage) {
      return this.adminDocenteLocalService.getDocenteCarga(id);
    }
  ...
  getUsuariosRegulares(page = 1, limit = 10): Observable<any[]> {
    if (this.useLocalStorage) {
      return this.adminDocenteLocalService.getUsuariosRegulares(page, limit);
    }
  ...
  getEstadisticas(): Observable<EstadisticasCarga> {
    if (this.useLocalStorage) {
      return this.adminDocenteLocalService.getEstadisticas();
    }
